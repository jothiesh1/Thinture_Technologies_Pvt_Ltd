...
@Composable
fun DealerEventReportScreen(navController: NavController) {
    ScaffoldWithDrawer(
                    ...
                    TimePickerDialog(
                        ...
                        { _, hour, minute ->
                            val selected = Calendar.getInstance().apply {
                                ...
                                set(Calendar.SECOND, if (isToDate) 59 else 0)
                            }
                ...
                AlertDialog(
                    ...
                    text = {
                        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                            Button(onClick = { showDateTimePicker({ fromDate = it }) }) {
                                Text(fromDate)
                            }
                            Button(onClick = { showDateTimePicker({ toDate = it }, isToDate = true) }) {
                                Text(toDate)
                            }
